  ...
  return (
    <section className="pb-12 sm:pb-24 bg-background">
      <div className="container mx-auto max-w-2xl px-4">
        <div className="bg-yellow-50 border-2 border-dashed border-yellow-500 rounded-lg p-6 sm:p-8 flex flex-col sm:flex-row items-center justify-center gap-6 text-center sm:text-left">
          <div className="bg-yellow-500/20 p-3 rounded-full">
            <ShieldCheck className="h-10 w-10 text-yellow-600 flex-shrink-0" />
          </div>
          <div>
